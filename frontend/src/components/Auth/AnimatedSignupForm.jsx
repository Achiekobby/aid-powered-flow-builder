...
const AnimatedSignupForm = ({ onSwitchToLogin }) => {
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="relative z-10 flex flex-col justify-center px-8 py-8">
          ...
          >
            ...
            >
              Join thousands of developers and businesses building powerful USSD
              applications for Ghana and across Africa. Get started in minutes.
            </motion.p>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Deploy your first USSD app in under 5 minutes
                  </p>
                </div>
              </motion.div>
            </motion.div>
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-600">
              Start building powerful USSD applications
            </p>
          </motion.div>
              ...
              >
                <label className="flex items-start">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-4 h-4 text-green-500 bg-gray-50 border-gray-300 rounded focus:ring-green-500 focus:ring-2 mt-0.5"
                    required
                  />
